        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    line_phone_number_id = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_broadcast_lists", x => x.id);
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "char(36)", nullable: false),
                    tenant_id = table.Column<Guid>(type: "char(36)", nullable: false),
                    broadcast_list_id = table.Column<Guid>(type: "char(36)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_broadcast_recipients_broadcast_lists_broadcast_list_id",
                        column: x => x.broadcast_list_id,
                        principalTable: "broadcast_lists",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_broadcast_lists_tenant_id",
                table: "broadcast_lists",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "IX_broadcast_lists_tenant_id_status",
                table: "broadcast_lists",
                columns: new[] { "tenant_id", "status" });

            migrationBuilder.CreateIndex(
                name: "IX_broadcast_recipients_broadcast_list_id",
                table: "broadcast_recipients",
                column: "broadcast_list_id");

            migrationBuilder.CreateIndex(
                name: "IX_broadcast_recipients_broadcast_list_id_status",
                table: "broadcast_recipients",
                columns: new[] { "broadcast_list_id", "status" });

            migrationBuilder.CreateIndex(
                name: "IX_broadcast_recipients_tenant_id_broadcast_list_id_contact_id",
                table: "broadcast_recipients",
                columns: new[] { "tenant_id", "broadcast_list_id", "contact_id" },
                unique: true);
        }

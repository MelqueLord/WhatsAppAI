...
public sealed class ServiceLineConfiguration : IEntityTypeConfiguration<ServiceLine>
{
    public void Configure(EntityTypeBuilder<ServiceLine> builder)
    {
        ...
        builder.Property(q => q.TransferNotice).HasColumnName("transfer_notice").HasMaxLength(ServiceLine.TransferNoticeMaxLength);
        builder.Property(q => q.InteractionReply).HasColumnName("interaction_reply").HasMaxLength(ServiceLine.InteractionReplyMaxLength);

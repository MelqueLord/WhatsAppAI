...
public interface IWhatsAppAccountRepository
{
    ...
    Task<WhatsAppAccount?> GetByTenantAndSlotIncludingInactiveAsync(Guid tenantId, WhatsAppConnectionType connectionType, int lineNumber, CancellationToken cancellationToken = default);

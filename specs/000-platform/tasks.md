...
- [X] **T224** Corrigir a navegação lateral em telas móveis, preservando rodapé e controle de recolhimento visíveis para todos os papéis. **Refs:** FR-066. **Paths:** `apps/web/src/components/Sidebar.tsx`, testes de componente e documentação. **Aceite:** cabeçalho e rodapé não saem da área visível; apenas a lista de itens rola; o controle de recolhimento permanece acionável após recolher o menu, inclusive para Operator.

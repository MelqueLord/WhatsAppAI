...
public class TestWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        var testSettings = new Dictionary<string, string?>
        {
            ...
            ["WhatsAppWeb:ApiServiceId"] = "webapi",
            ["WhatsAppWeb:BridgeServiceId"] = "whatsapp-web",
            ["WhatsAppWeb:ServiceToken"] = "integration-test-whatsapp-web-service-token-at-least-32-bytes",
            ["WhatsAppWeb:PreviousServiceToken"] = "integration-test-whatsapp-web-previous-service-token",
            ["WhatsAppWeb:PreviousServiceTokenExpiresAt"] = "2099-01-01T00:00:00Z",

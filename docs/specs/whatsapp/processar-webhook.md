...
Se houver perda, vazamento entre tenants, segredo exposto ou envio incorreto, tratar como incidente de segurança, suspender a integração afetada e seguir `docs/regras/seguranca.md`.

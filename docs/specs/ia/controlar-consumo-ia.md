...
Leia este arquivo, `docs/contexto/fluxos-implementados.md`, `docs/decisoes/0010-platform-managed-ai-allowances.md` e as seções US-012/FR-044/FR-045 de `docs/specs/plataforma/especificacao-plataforma.md` antes de alterar código.
...
Prompt sugerido para retomada: “Leia `docs/specs/ia/controlar-consumo-ia.md` e revise somente as lacunas ainda abertas, sem duplicar a regra de franquia nem alterar o que já está validado.”

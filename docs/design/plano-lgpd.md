...
**Branch**: `master` | **Date**: 2026-08-27 | **Spec**: [controles LGPD](../specs/uso-auditoria/controles-lgpd.md)

**Input**: Feature specification in `../specs/uso-auditoria/controles-lgpd.md`
...
```text
docs/specs/uso-auditoria/controles-lgpd.md
docs/design/plano-lgpd.md
docs/pesquisa/lgpd-prontidao-producao.md
docs/design/modelo-dados-lgpd.md
docs/tasks/validacao-lgpd.md
docs/specs/uso-auditoria/privacy-api.yaml
docs/tasks/lgpd-prontidao-producao.md
```
...
docs/regras/
docs/decisoes/0008-lgpd-operational-controls.md
```

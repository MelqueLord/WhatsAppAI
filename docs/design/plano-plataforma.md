...
- `docs/decisoes/0001-modular-monolith.md`;
- `docs/decisoes/0002-official-whatsapp-cloud-api.md`;
- `docs/decisoes/0003-customer-owned-provider-billing.md` (histórico, substituído para IA pelo ADR-0010);
- `docs/decisoes/0004-no-n8n-core.md`;
- `docs/decisoes/0005-postgres-inbox-outbox.md`;

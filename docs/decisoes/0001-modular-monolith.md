...
Usar um monólito modular .NET, uma base relacional PostgreSQL única e um frontend React separado. Módulos têm limites de código, mas compartilham transação quando necessário.

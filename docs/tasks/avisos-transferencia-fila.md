...
- [ ] T008 Validate migration, backend build, relevant tests and frontend build; update `validacao-avisos-fila.md` if needed.
...
- [X] T016 [US5] Clarify the business-specific AI welcome message in `apps/web/src/features/bot/BotConfigPage.tsx` and document the queued-AI validation flow in `validacao-avisos-fila.md`.

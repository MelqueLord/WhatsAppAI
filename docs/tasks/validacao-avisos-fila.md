...
6. Send a message with no applicable AI action while the conversation remains automatic in the queue and verify the customer receives `Sua conversa segue na fila Support. Se quiser mudar de assunto, me diga por aqui.`.

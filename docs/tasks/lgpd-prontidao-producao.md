...
**Input**: Documentos de especificação, design e pesquisa de LGPD em `docs/`.

**Tests**: Unit, integration, tenant isolation, migration and release build are required.

## Phase 1: Setup

- [X] T001 Record the privacy architecture decision in `docs/decisoes/0008-lgpd-operational-controls.md`
...
- [X] T011 [P] [US3] Create RIPD and controller/operator procedure in `docs/regras/lgpd-ripd.md` and update `docs/regras/lgpd-checklist.md`

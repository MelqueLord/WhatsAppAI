...
API e workers podem começar no mesmo processo/artefato. PostgreSQL guarda estado, Inbox e Outbox. Separar o worker em processo independente é uma opção de deploy, não um novo serviço de domínio.

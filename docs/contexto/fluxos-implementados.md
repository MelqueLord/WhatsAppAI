...
Referências: `docs/specs/plataforma/especificacao-plataforma.md`, `docs/regras/inteligencia-artificial.md` e `docs/design/arquitetura-geral.md`.
...
- Métricas, health checks e alertas estão descritos em `docs/specs/producao/observabilidade.md`.
...
- Testes de isolamento por tenant e contratos/integração ficam na estratégia em `docs/regras/testes.md`.
...
|---|---|
| Regras de comportamento da IA | `docs/regras/inteligencia-artificial.md` |
| Arquitetura e limites | `docs/design/arquitetura-geral.md` |
| Segurança/LGPD | `docs/regras/lgpd-checklist.md` e `docs/regras/seguranca.md` |
| Observabilidade | `docs/specs/producao/observabilidade.md` |
| Estratégia de testes | `docs/regras/testes.md` |
| Retomada do controle de franquia de IA | `docs/specs/ia/controlar-consumo-ia.md` |
| Contrato do produto | `docs/specs/plataforma/especificacao-plataforma.md` |
| Plano técnico | `docs/design/plano-plataforma.md` |
| Tarefas e rastreabilidade | `docs/tasks/plataforma.md` |

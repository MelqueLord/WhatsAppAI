...
Antes de abrir uma nova frente, consultar também `docs/contexto/fluxos-implementados.md`, `docs/regras/inteligencia-artificial.md`, `docs/design/arquitetura-geral.md`, `docs/regras/` e `docs/specs/`.

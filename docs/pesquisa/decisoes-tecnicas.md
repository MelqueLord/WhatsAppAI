...
- `docs/decisoes/0001-modular-monolith.md` — monólito modular.
- `docs/decisoes/0002-official-whatsapp-cloud-api.md` — canal Cloud oficial da Meta.
- `docs/decisoes/0009-baileys-production-qr.md` — ponte Baileys para conexões QR em produção.
- `docs/decisoes/0003-customer-owned-provider-billing.md` — contas e faturamento dos tenants.
- `docs/decisoes/0004-no-n8n-core.md` — n8n fora do núcleo.
- `docs/decisoes/0005-postgres-inbox-outbox.md` — filas duráveis em PostgreSQL.
- `docs/decisoes/0008-postgresql-only.md` — PostgreSQL único, Supabase e Docker.
